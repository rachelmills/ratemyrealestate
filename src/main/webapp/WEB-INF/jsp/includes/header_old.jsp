		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav nav-tabs">
					<li><a href="<c:url value="/"/>">Home <!-- <span class="sr-only">(current)</span> -->
					</a></li>
					<li class="active"><a href="/about">About</a></li>
					<li class="dropdown"><a href="<c:url value="/allratings"/>"
						class="dropdown-toggle" data-toggle="dropdown" role="button"
						aria-haspopup="true" aria-expanded="false">View ratings <span
							class="caret"></span></a>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><c:url var="logoutUrl" value="/logout"></c:url> <form:form
							id="logoutForm" action="${logoutUrl}" method="post">
						</form:form> <!-- for bootstrap --> <a href="#"
